...
- [indexer-rs](https://github.com/SentrisCloud/indexer-rs) - Rust indexer. Multi-endpoint round-robin + batched writes (~270 blocks/sec on mainnet catch-up). Mainnet primary; testnet migration in progress.
